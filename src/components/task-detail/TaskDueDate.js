...
export const TaskDueDate = ({task,onConvertDateT,onSetShowDateSel, onUpdateTask, showDueDateSel}) => {
	return (
		<div onClick={(event)=>onSetShowDateSel(event,'dueDate')} className="row task-item-detail-dueDate task-item-detail-elem"
			...
			<div className="task-detail-font-size" style={{ padding: 10,width:75+'%' }}>
